/*! science-sims - v0.1.0 - 2017-05-08 */ 
/**
* Draws an arrow from one point to another. Useful for vector diagramming.
* @constructor Arrow

 * @description  An Arrow that points somewhere.
...
var movingBackground = function(whichKind_, position_, initialVelocity_, acceleration_) {
    maxHeight = 100;
