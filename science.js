...
// it take two argumnets: the origin and the target, both of which are p5 vectors
...
Arrow.prototype.display = function(){
  ...
  noStroke();
  //draw arrow
  //console.log(this.origin.x,this.target.x);
...
if (buffer === undefined){ buffer = 2; }   // higher # = less accurate
...
function drawArrow0(thickness,length,arrow){
  //draw the arrow itself
//console.log(length);
  translate(0,-thickness/2);
  // rect(0, thickness/4, length, thickness/2);
